...
export default function DigitalDirectoryPlaceholderScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.subtitle}>Features in progress. We are actively building this module to bring you a seamless digital directory experience.</Text>
      </View>
    </View>
  );
}
